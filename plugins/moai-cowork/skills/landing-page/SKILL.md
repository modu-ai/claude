...
description: |
  ...
  [책임 경계] vs moai-cowork:product-detail: 이 스킬=단독 전환 랜딩 1페이지(캠페인·이벤트·리드 수집), 저 스킬=카탈로그 제품 상세 페이지(스마트스토어·쿠팡·카카오 규격, 옵션·비교).
version: 0.1.0
---
...
- `moai-cowork:product-detail` — 제품 상세 페이지 (이커머스)
- `moai-cowork:sns-content` — 소셜미디어 콘텐츠
- `moai-cowork:copywriting` — 광고 카피 단독 작성
- `moai-cowork:blog` — SEO 블로그 포스팅

## 이 스킬을 사용하지 말아야 할 때

- 블로그 포스팅: `moai-cowork:blog` 스킬 사용
- SNS 포스팅: `moai-cowork:sns-content` 스킬 사용
- 이메일 뉴스레터: `moai-cowork:newsletter` 스킬 사용
- 제품 상세페이지: `moai-cowork:product-detail` 스킬 사용
- 데이터 대시보드: `moai-cowork:data-visualizer` 스킬 사용
