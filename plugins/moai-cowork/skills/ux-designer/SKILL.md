...
description: |
  ...
  [책임 경계] vs moai-cowork:ux-researcher: ux-designer=휴리스틱·접근성·플로우 평가, ux-researcher=인터뷰·페르소나·VOC 리서치
version: 0.1.0
---
...
| 스킬 | 사용 시점 |
|------|----------|
| `moai-cowork:ux-researcher` | 선행 작업: 사용자 리서치가 필요한 경우 |
| `moai-cowork:spec-writer` | 후속 작업: UX 사양서 작성 필요 시 |
| `moai-cowork:landing-page` | 대안: 랜딩 페이지 UX 개선 필요 시 |

## 후처리 체인

UX 분석 보고서의 **서술형 권고안 부분**(통합 UX 권고안 P0~P3 설명, 개선 로드맵 서술)만 다음 체인으로 마무리합니다. 심각도·RICE·우선순위 매트릭스 같은 표·점수 데이터는 정제 대상이 아닙니다:

`moai-cowork:ux-designer → moai-cowork:ai-slop-reviewer → moai-cowork:humanize-korean`
