...
본 스킬(`moai-cowork:design-system-library`)은 **moai-design 플러그인의 정본**을 가리키는 포인터입니다.
...
- 적용처: `moai-cowork:html-report` · `moai-cowork:html-slide` (design_system 파라미터로 토큰 로드)
