...
3. 데이터 구조 확인 → 부적합 시 `moai-officer:office-data-explorer` 권유
4. 차트 산출 후 사용자 검토 요청

## 이 스킬을 사용하지 말아야 할 때
- **데이터 탐색/프로파일링** → `moai-officer:office-data-explorer` 사용
- **공공데이터 조회** → `moai-officer:office-public-data-public-data` 사용
