...
- **before**: `moai-cowork:business-consulting-brief` — 실사 대상 법인 목록 정리
- **after**: `moai-cowork:legal-legal-risk` — 발급된 등기부등본 기반 법적 리스크 분석
- **after**: `moai-cowork:office-xlsx-creator` — 종합 리포트 Excel화
