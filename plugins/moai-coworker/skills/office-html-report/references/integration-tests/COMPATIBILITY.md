...
## 1. moai-cowork:business-executive-summary → mode=status
...
```
moai-cowork:business-executive-summary → moai-cowork:general-ai-slop-reviewer → moai-cowork:office-html-report mode=status
```
...
## 2. moai-cowork:finance-financial-statements → mode=financial
...
```
moai-cowork:finance-financial-statements → moai-cowork:office-html-report mode=financial
```
...
## 3. moai-cowork:business-sbiz365-analyst → mode=plan
...
```
moai-cowork:business-sbiz365-analyst → moai-cowork:general-ai-slop-reviewer → moai-cowork:general-humanize-korean → moai-cowork:office-html-report mode=plan
```
...
## 4. moai-cowork:office-daily-briefing → mode=status (daily variant)
...
```
moai-cowork:office-daily-briefing → moai-cowork:office-html-report mode=status
```
...
|---|---|---|---|---|
| moai-cowork:business-executive-summary | status | 7개 | 3개 | **4** |
| moai-cowork:finance-financial-statements | financial | 6개 | 4개 | **4** |
| moai-cowork:business-sbiz365-analyst | plan | 6개 | 3개 | **4** |
| moai-cowork:office-daily-briefing | status | 5개 | 3개 | **4** |
...
*작성: moai-cowork:office-html-report 통합 검증*
