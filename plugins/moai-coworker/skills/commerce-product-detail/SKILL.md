...
description: |
  ...
  코드 생성 전에 디자인 톤(색·모드·모서리·효과)을 먼저 묻습니다. 기획은 moai-coworker:commerce-detail-page-planner, 카피는 moai-coworker:commerce-detail-page-copy, 이미지는 moai-coworker:commerce-detail-page-image로 이어집니다.
  [책임 경계] vs 페어 스킬: 이 스킬=코드 산출, moai-coworker:commerce-detail-page-copy=13섹션 카피 JSON, moai-coworker:marketing-landing-page=단독 전환 랜딩 1페이지.
version: "5.0.0"
---
...
- `moai-coworker:marketing-landing-page` — 랜딩 페이지 (단독 전환 목적)
- `moai-coworker:content-sns-content` — 소셜미디어 콘텐츠
- `moai-coworker:content-copywriting` — 광고 카피

## 이 스킬을 사용하지 말아야 할 때

- 블로그 포스팅/리뷰 글: `moai-coworker:content-blog` 스킬 사용
- SNS 포스팅: `moai-coworker:content-sns-content` 스킬 사용
- 랜딩 페이지: `moai-coworker:marketing-landing-page` 스킬 사용
- 광고 카피 단독 작성: `moai-coworker:content-copywriting` 스킬 사용
