...
- **moai-cowork:strategy-planner**: 전략 기획서 작성 시 활용
- **moai-cowork:market-analyst**: 시장 분석이 필요한 경우 먼저 실행
- **moai-cowork:pptx-designer**: 브리프를 PPT로 변환
- **moai-cowork:ai-slop-reviewer → moai-cowork:humanize-korean**: 최종 산출물 AI 패턴 검수 후 한국어 표현을 자연스럽게 다듬습니다 (필수)
