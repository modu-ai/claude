...
```
process-manager → moai-cowork:ai-slop-reviewer → moai-cowork:humanize-korean
```

- `moai-cowork:ai-slop-reviewer` — 문서 본문의 AI 티 패턴을 검수·수정합니다.
- `moai-cowork:humanize-korean` — 검수된 본문을 자연스러운 한국어 실무 문체로 다듬습니다.
