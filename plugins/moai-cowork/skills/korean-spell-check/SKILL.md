...
- **before**: `moai-cowork:blog`, `moai-cowork:newsletter`, `moai-cowork:copywriting`, `moai-cowork:sns-content`
- **before**: `moai-cowork:ai-slop-reviewer` — AI 패턴(과한 형용사·반복·번역체) 먼저 검수
