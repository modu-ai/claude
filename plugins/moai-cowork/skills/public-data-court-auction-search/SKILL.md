---
name: public-data-court-auction-search
description: |
...
- **before**: `moai-cowork:public-data-real-estate-search` — 매물 시세 비교 (인근 실거래가)
- **after**: `moai-cowork:financial-statements` — 경매 투자 타당성 분석
- **after**: `moai-cowork:executive-summary` — 경매 후보 1pager
- **after**: `moai-cowork:xlsx-creator` — 매각공고 일괄 엑셀화
