...
title: "가이드 문서 색인"
weight: 90
description: "Claude 공식 고객지원 센터의 모든 가이드 문서와 모두의 클로드 페이지 매핑 색인."
geekdocBreadcrumb: true
---

이 색인은 Claude 공식 고객지원 센터 [Claude 컬렉션](https://support.claude.com/en/collections/4078531-claude)의 가이드 문서를, 모두의 클로드의 어느 페이지에서 한국어로 다루는지 매핑한 것입니다. 원문을 직접 확인하고 싶을 때 출발점으로 활용하세요. (총 69개 문서를 15개 주제 페이지로 정리했습니다. 개발자/CLI·SDK 영역은 다루지 않습니다.)
...
- [Use the Claude Agent SDK with your Claude plan](https://support.claude.com/en/articles/15036540-use-the-claude-agent-sdk-with-your-claude-plan) — 개발자/CLI·SDK 영역, 다루지 않음
- [Use Claude in Xcode](https://support.claude.com/en/articles/12293051-use-claude-in-xcode) — 개발자/IDE 연동, 다루지 않음
- [Use Claude in Microsoft Foundry](https://support.claude.com/en/articles/12864745-use-claude-in-microsoft-foundry) — 개발자 배포, 다루지 않음
