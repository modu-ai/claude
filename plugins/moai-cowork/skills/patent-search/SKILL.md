...
description: |
  ...
  특허 목록·핵심 청구항 요약·IPC 분류별 분포를 정리하고, 선행기술 조사·FTO·출원서가 필요하면 moai-cowork:patent-analyzer로 이어집니다.
version: 0.1.0
---
...
- "선행기술 조사" → moai-cowork:patent-analyzer 스킬 연계
- "특허 맵 분석" → moai-cowork:patent-analyzer 스킬 연계
- "출원서 작성" → moai-cowork:patent-analyzer 스킬 연계
- "FTO 분석" → moai-cowork:patent-analyzer 스킬 연계
...
- 선행기술 조사, FTO 분석, 출원서 작성이 필요한 경우 moai-cowork:patent-analyzer 스킬로 연계합니다.

## 관련 스킬

- **moai-cowork:patent-analyzer** - 선행기술 조사, FTO 분석, 출원서 작성
- **moai-cowork:grant-writer** - 연구비 신청서 선행기술 섹션 작성
- **moai-cowork:data-visualizer** - 특허 동향 시각화 (연도별 추이, IPC 분포 차트)
