...
## 1. moai-cowork:executive-summary → mode=status
...
```
moai-cowork:executive-summary → moai-cowork:ai-slop-reviewer → moai-cowork:html-report mode=status
```
...
## 2. moai-cowork:financial-statements → mode=financial
...
```
moai-cowork:financial-statements → moai-cowork:html-report mode=financial
```
...
## 3. moai-cowork:sbiz365-analyst → mode=plan
...
```
moai-cowork:sbiz365-analyst → moai-cowork:ai-slop-reviewer → moai-cowork:humanize-korean → moai-cowork:html-report mode=plan
```
...
## 4. moai-cowork:daily-briefing → mode=status (daily variant)
...
```
moai-cowork:daily-briefing → moai-cowork:html-report mode=status
```
...
|---|---|---|---|---|
| moai-cowork:executive-summary | status | 7개 | 3개 | **4** |
| moai-cowork:financial-statements | financial | 6개 | 4개 | **4** |
| moai-cowork:sbiz365-analyst | plan | 6개 | 3개 | **4** |
| moai-cowork:daily-briefing | status | 5개 | 3개 | **4** |
...
*작성: moai-cowork:html-report 통합 검증*
