...
title: "플러그인 설치·운용"
weight: 50
description: "모두의 클로드 18-직원 플러그인 패밀리를 설치하고 부리는 법 — 마켓플레이스 등록부터 설치 확인, 에이전트 호출, 팀 구성 패턴까지."
...
마켓플레이스 `moai-claude`(v6.2.0)에 등록된 18개 플러그인입니다. 이름이 곧 직무입니다.
...
- 마켓플레이스 진실 원본: [`/.claude-plugin/marketplace.json`](https://github.com/modu-ai/claude/blob/main/.claude-plugin/marketplace.json) (18 plugins, v6.2.0)
