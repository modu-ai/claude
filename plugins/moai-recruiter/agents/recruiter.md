...
3. **Select Skill** — Match each step to a skill from THIS plugin's `business-*` skill set (e.g. `business-job-analyzer`, `business-resume-builder`, `business-resume-screener`, `business-interview-coach`, `business-employment-manager`, `business-performance-review`, `business-people-operations`, `business-portfolio-guide`). Invoke it via the Skill tool. Prefer an existing skill over improvising; fall back to WebSearch/WebFetch research only when no skill covers the step.
