...
- `moai-cowork:detail-page-copy` — 카피 생성
- `moai-cowork:detail-page-image` — 이미지 합성
- `moai-cowork:marketplace-coupang` — 쿠팡 비교
- `moai-cowork:seo-audit` — 네이버 SEO 일반
- `moai-cowork:campaign-planner` — 시즌 캠페인 기획
