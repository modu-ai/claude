...
> 탐지 원본: `plugins/moai/skills/moai-domain-humanize/modules/korean.md` D/J 카테고리. general-ai-slop-reviewer 및 general-humanize-korean에도 동일 3종이 등록되어 있어, cd-slop-check가 잡지 못한 경우 후속 게이트가 보완합니다.
