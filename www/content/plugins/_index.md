...
title: "플러그인 카탈로그"
weight: 50
description: "Claude 제품 라인을 확장하는 4개 플러그인 카테고리 — Chat에서 스킬·플러그인 활용 (문서 허브) · moai-cowork (한국 실무 171스킬) · moai-design (에이전틱 디자인) · moai-code (무설치 개발 방법론) · moai-story (작가·콘텐츠 + Higgsfield). v4.0.0에서 moai-story가 신설되어 4종 빌드 플러그인 패밀리가 되었습니다."
