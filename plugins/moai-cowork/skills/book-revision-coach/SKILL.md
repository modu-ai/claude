...
> 💡 본 스킬은 1차 점검만 수행. 정밀 맞춤법은 `moai-cowork:korean-spell-check`(바른한글) 체이닝 권장.
...
- **다음 단계**: 수정 후 moai-cowork:ai-slop-reviewer → moai-cowork:humanize-korean 체이닝
```
...
| **AI 티 무시** | `moai-cowork:ai-slop-reviewer` → `moai-cowork:humanize-korean` 체이닝 필수 |
...
1차 어법·문체·논리 (book-revision-coach) ← 본 스킬
  ↓
정밀 맞춤법 (moai-cowork:korean-spell-check, 바른한글)
  ↓
AI 슬롭 검수 (moai-cowork:ai-slop-reviewer) ← 필수
  ↓
AI 티 윤문 (moai-cowork:humanize-korean) ← 필수
  ↓
...
### After (체이닝 — 정규 체인)
- `moai-cowork:korean-spell-check` — 정밀 한국어 맞춤법
...
> 퇴고 완료 본문은 정규 체인 **`book-revision-coach → moai-cowork:ai-slop-reviewer → moai-cowork:humanize-korean`**으로 마무리합니다.

### Alternative
- `moai-cowork:korean-spell-check` 단독 — 빠른 맞춤법만
- `moai-cowork:ai-slop-reviewer` 단독 — 빠른 AI 티 검출만
