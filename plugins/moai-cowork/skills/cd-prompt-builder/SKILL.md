...
- 카피 검수 필요 → moai-cowork:cd-slop-check
```
...
| 스킬 | 사용 시점 |
|---|---|
| `moai-cowork:cd-brief` | 대안: 일반적 6요소 브리프 (시니어 패턴이 필요 없을 때) |
| `moai-cowork:cd-system-prep` | 선행: 디자인 시스템 자산 합성 |
| `moai-cowork:cd-slop-check` | 후속: 결과 카피 검수 |
| `moai-cowork:ux-designer` | 보조: Claude Design 외 UX 분석 |
| `moai-cowork:ux-researcher` | 보조: 사용자 리서치 단계 |
