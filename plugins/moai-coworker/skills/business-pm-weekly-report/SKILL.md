...
- **moai-coworker:general-humanize-korean**: 한국어 자연스러움 보정 (general-ai-slop-reviewer 다음 단계)
- **moai-coworker:business-executive-summary**: 1pager를 더 압축된 C-level 보고로 변환
- **moai-coworker:office-pptx-designer**: 슬라이드 발표 자료로 출력
...
- **NDA 정보 주의**: 외부 공유용 보고서 작성 시 회사 비밀 정보 자동 검사 (`moai-coworker:legal-nda-triage` 권고)
...
- `moai-coworker:general-humanize-korean` — 한국어 자연스러움 보정 (general-ai-slop-reviewer 다음)
- `moai-coworker:business-executive-summary` — C-level 1pager로 더 압축
- `moai-coworker:office-pptx-designer` — 발표 슬라이드 출력

**Alternative**:
- `moai-coworker:office-daily-briefing` — 일간 보고 (주간이 아닌 일일)

## 관련 커맨드

- 등록된 스킬 체인:
  - 주간보고 본문 후처리(표준): `weekly-report → moai-coworker:general-ai-slop-reviewer → moai-coworker:general-humanize-korean`
  - 주간보고 → 임원 1pager: `weekly-report → moai-coworker:general-ai-slop-reviewer → moai-coworker:general-humanize-korean → moai-coworker:business-executive-summary`
  - 발표 슬라이드: `weekly-report → moai-coworker:general-ai-slop-reviewer → moai-coworker:general-humanize-korean → moai-coworker:office-pptx-designer`
