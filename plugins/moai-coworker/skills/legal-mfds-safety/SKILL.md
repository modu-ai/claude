...
- **before**: `moai-coworker:commerce-integrated-strategy` — 헬스/F&B 신상품 기획 시 안전성 검토
- **after**: `moai-coworker:commerce-detail-page-copy` — 안전 정보 반영한 상세페이지 카피
- **after**: `moai-coworker:commerce-product-detail` — 안전성 안내 콘텐츠 작성
