...
- **AI 슬롭 제거·윤문** → `moai-writer:office-korean-spell-check` / `humanize-korean`
...
- **after**: `moai-writer:office-korean-spell-check` — 파싱된 텍스트 맞춤법·문체 교정
- **after**: `moai-officer:office-data-explorer` — 파싱된 표 데이터 분석
...
- **after**: `moai-officer:office-data-visualizer` — 파싱된 표 데이터 차트 시각화
