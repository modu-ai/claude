...
description: |
  ...
  [책임 경계] vs moai-marketer:media-notebooklm-slide-prompt: 이 스킬=지금 바로 열리는 .pptx 파일, 저 스킬=NotebookLM에 넣을 슬라이드 생성 프롬프트.
version: "5.0.0"
---
...
| `moai-marketer:media-gemini-3-image-prompt` | 슬라이드 일러스트·배경 이미지 프롬프트 |
