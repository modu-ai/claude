...
Phase 3에서 설계된 각 산출물 체인을 `{workflow_chains}` 슬롯에 인라인 스킬 체인으로 주입한다:
...
```
moai-pm/skills/project/references/templates/CLAUDE.md.tmpl
```
...
| `{workflow_chains}` | Phase 3에서 설계된 체인 블록(Markdown — §2.3 형식) |
...
```
1. 템플릿 로드
   Read: moai-pm/skills/project/references/templates/CLAUDE.md.tmpl

2. 변수 수집
   - Phase 1 인터뷰 결과
   - Phase 2 감지된 플러그인·스킬 인벤토리
   - Phase 3 스킬 체인 설계
...
- 템플릿: `moai-pm/skills/project/references/templates/CLAUDE.md.tmpl`
