...
description: |
  ...
  - "이 분야 연구 동향 파악해줘"
  - "참고문헌 BibTeX로 정리해줘"
  핵심 논문 요약·연도별 연구 동향·참고문헌(BibTeX/RIS/텍스트)을 만들고, 논문 작성이 필요하면 moai-cowork:paper-writer로 이어집니다.
version: 0.1.0
---
...
- "논문 작성" → moai-cowork:paper-writer 스킬 연계
...
- 논문 작성이 필요한 경우 moai-cowork:paper-writer 스킬로 연계하여 참고문헌 인용 포맷을 자동 생성할 수 있습니다.

## 관련 스킬

- **moai-cowork:paper-writer** - 논문 작성 및 참고문헌 포맷팅
- **moai-cowork:grant-writer** - 연구비 신청서 선행연구 조사 섹션 작성
- **moai-cowork:data-visualizer** - 연구 동향 시각화 (연도별 추세 차트)
