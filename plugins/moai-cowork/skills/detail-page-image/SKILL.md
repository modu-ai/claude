...
description: >
  ...
  moai-cowork:higgsfield-image(Nano Banana Pro 등 11개 모델)로 13장의 이미지를 생성한 뒤
...
moai-cowork:higgsfield-image를 백엔드로 사용하여 카테고리별 비주얼 톤이 일관된 13장의 섹션 이미지를 만들고,
...
2. **moai-cowork 플러그인 활성화**: 13섹션 이미지 생성에 higgsfield-image 사용
...
### 3단계: 이미지 생성 (moai-cowork:higgsfield-image)
...
- `moai-cowork:detail-page-copy` — 13섹션 카피 생성 (이 스킬 입력)
- `moai-cowork:product-photo-brief` — 상품 사진 사전 분석
- 13섹션 이미지 생성 — **Higgsfield MCP**(Soul·시네마틱 이미지·캐릭터) 직접 호출
- `moai-cowork:marketplace-coupang` — 채널별 이미지 규격 가이드
...
- shadcn/ui 기반 웹 상세페이지: `moai-cowork:product-detail`
