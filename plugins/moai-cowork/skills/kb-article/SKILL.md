...
```
kb-article → moai-cowork:ai-slop-reviewer → moai-cowork:humanize-korean
```
...
- **고객 문의 직접 응답** → moai-cowork:draft-response 스킬이 더 적합합니다
- **티켓 분류 및 우선순위 판단** → moai-cowork:ticket-triage 스킬을 사용하세요
