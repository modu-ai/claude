...
| CSV/Excel 통계 파일 분석 | `moai-officer:office-data-explorer` | 파싱된 파일 분석. |
| 차트 시각화 | `moai-officer:office-data-visualizer` | 차트 생성. |
...
### Step 4: 결과 정리
- 마크다운 테이블로 데이터 표시
- 시각화 필요 시 moai-officer:office-data-visualizer 연계
...
- **CSV/Excel 분석** → `moai-officer:office-data-explorer` 사용
- **차트 생성** → `moai-officer:office-data-visualizer` 사용
