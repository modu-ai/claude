...
description: |
  ...
  후속으로 moai-coworker:general-humanize-korean 체이닝을 권장합니다.
...
> 탐지 원본: `plugins/moai-code/skills/moai-domain-humanize/modules/korean.md` D/J 카테고리. general-ai-slop-reviewer 및 general-humanize-korean에도 동일 3종이 등록되어 있어, cd-slop-check가 잡지 못한 경우 후속 게이트가 보완합니다.
...
2. 한국어 카피 자연화 → moai-coworker:general-humanize-korean
...
- 후속으로 moai-coworker:general-humanize-korean 체이닝 권장 (한국어 결과)
...
| 스킬 | 사용 시점 |
|---|---|
| `moai-coworker:general-humanize-korean` | 후속: 한국어 카피 자연화 (10대 카테고리 × 40+ AI 티 패턴 SSOT) |
| `moai-core:general-ai-slop-reviewer` | 후속: 모든 텍스트 산출물의 일반 AI 슬롭 검수 |
| `moai-design:cd-brief` | 선행: 더 좋은 카피가 나오도록 브리프 정돈 |
| `moai-coworker:marketing-campaign-planner` | 보조: 캠페인 카피의 톤·메시지 일관성 검토 |
| `moai-coworker:content-copywriting` | 대안: Claude Design 외부에서 카피 직접 생성 |
