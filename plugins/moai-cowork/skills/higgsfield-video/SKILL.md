...
| 스킬 | 시점 |
|---|---|
| `moai-cowork:higgsfield-image` | 선행: 시작 이미지·캐릭터 reference 생성 |
| `moai-cowork:audio-gen` | 보조: 영상에 추가할 음성·BGM 생성 |
| `moai-cowork:landing-page` | 후속: 영상을 랜딩에 배치 |
| `moai-cowork:campaign-planner` | 보조: 캠페인 단위 영상 시리즈 |
| `moai-cowork:detail-page-image` | 보조: 상세페이지 영상 |
| `moai-cowork:live-commerce` | 보조: 라이브 커머스 |
