...
description: |
  ...
  [책임 경계] vs moai-cowork:market-analyst: 이 스킬=학술 논문과 연구 리서치, 저 스킬=시장 조사와 비즈니스 리서치.
version: 0.1.0
---
...
- **커리큘럼 및 강의 설계** → moai-cowork:curriculum-designer 스킬이 더 적합합니다
- **시험 문제 출제** → moai-cowork:assessment-creator 스킬을 사용하세요
- **시장 조사·비즈니스 리서치** → moai-cowork:market-analyst 스킬이 더 적합합니다
