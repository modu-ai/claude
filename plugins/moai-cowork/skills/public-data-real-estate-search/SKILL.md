---
name: public-data-real-estate-search
description: |
...
- **before**: `moai-cowork:public-data-public-data` — 인구·가구 통계로 입지 분석 보조
- **after**: `moai-cowork:market-analyst` — 시세 데이터 기반 시장 분석
- **after**: `moai-cowork:investor-relations` → `moai-cowork:pptx-designer` — 투자 IR 자료
- **after**: `moai-cowork:landing-page` — 부동산 마케팅 페이지 데이터 입력
