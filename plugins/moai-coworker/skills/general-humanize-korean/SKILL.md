...
> **v2.2 카피·IT 장르 번역투 (A-20~A-23)**: 워크플로우·자동화·시스템 주제 카피·헤드라인·CTA·렌딩문에서 빈도 높은 4종 — `굴러가다/굴리다`(run/roll 직역) · 추상명사 종결→동사 종결("하나의 흐름으로/이 됩니다") · `나 대신/나와 함께 일합니다`(works for/with me 직역) · 직역 은유·비유(metaphor calque). A-20·A-21은 S1(무조건 제거), A-22·A-23은 S2. 사용자 제공 14개 before/after 샘플 기반 승격(재현 2회+). 상세 탐지는 `references/ai-tell-taxonomy.md` A-20~A-23, 치환은 `references/rewriting-playbook.md` v2.2 카피 레시피. **v2.3 추가**: `I-7` 비즈니스 카피 공식 표현 "당사는/저희는 + ~합니다/드립니다" [S2] — 비즈니스·CS·이메일 장르. **비유·과장·의인화 탐지 시 K-1(구체 사실)·K-2(절제·곡언) 양성 처방으로 대체** — 한국인 정서 카피의 핵심.
