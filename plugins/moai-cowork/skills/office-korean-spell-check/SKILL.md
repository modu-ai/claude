---
name: office-korean-spell-check
description: |
...
> 본 스킬은 NomaDamas k-skill `office-korean-spell-check` (MIT)를 cowork에 포팅했습니다. 공개 웹 검사기 기준이며, 최종 문맥 판단은 사람이 확인합니다.
...
```
{콘텐츠 생성 스킬} → general-ai-slop-reviewer → office-korean-spell-check → 사용자 최종 검토
```

- **before**: `moai-cowork:content-blog`, `moai-cowork:content-newsletter`, `moai-cowork:content-copywriting`, `moai-cowork:content-sns-content`
- **before**: `moai-cowork:general-ai-slop-reviewer` — AI 패턴(과한 형용사·반복·번역체) 먼저 검수
