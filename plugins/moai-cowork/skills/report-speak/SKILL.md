...
- **moai-cowork:meeting-facilitator**: 보고가 회의로 이어질 때 진행 설계
- **moai-cowork:feedback-loop**: 진행 중 중간 보고·피드백 요청
- **moai-cowork:conflict-handler**: 까다로운 상사·반응에 대한 대응
- **moai-cowork:docx-generator**: 구두 보고를 문서 보고서로 정리

## 이 스킬을 사용하지 말아야 할 때

- **문서·보고서 자체를 작성**: 글로 된 산출물은 `moai-office` / `moai-content`를 쓴다. 이 스킬은 말과 구조에 집중한다.
- **공식 성과평가 면담**: 평가·고과 피드백은 `moai-cowork:performance-review`를 사용한다.
