...
```
moai-coworker:business-executive-summary → moai-coworker:general-ai-slop-reviewer → moai-coworker:office-html-report mode=status
```
...
## 2. moai-coworker:finance-financial-statements → mode=financial
...
```
moai-coworker:finance-financial-statements → moai-coworker:office-html-report mode=financial
```
...
```
moai-coworker:business-sbiz365-analyst → moai-coworker:general-ai-slop-reviewer → moai-coworker:general-humanize-korean → moai-coworker:office-html-report mode=plan
```
...
## 4. moai-coworker:office-daily-briefing → mode=status (daily variant)
...
```
moai-coworker:office-daily-briefing → moai-coworker:office-html-report mode=status
```
...
| moai-coworker:finance-financial-statements | financial | 6개 | 4개 | **4** |
| moai-coworker:business-sbiz365-analyst | plan | 6개 | 3개 | **4** |
| moai-coworker:office-daily-briefing | status | 5개 | 3개 | **4** |
...
*작성: moai-coworker:office-html-report 통합 검증*
