...
![내보내기 메뉴 — 6가지 출력 형식 선택](/screenshots/claude-design/cd-export-menu.png)
...
![Claude Code /design-sync — 코드베이스 디자인 시스템을 Claude Design으로 (코드→디자인)](/screenshots/claude-design/cd-design-sync.png)
...
### Claude Code 터미널 에서 직접 진입 (`/design`)
...
![Claude Code 사이드바에서 Claude Design 진입](/screenshots/claude-design/cd-handoff-cc.png)
