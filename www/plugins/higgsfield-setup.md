# Higgsfield MCP 설정 가이드

moai-story 플러그인의 생성형 스킬(story-webtoon-art·story-conti·story-ad-conti·story-character-sheet·story-cover-art·story-previz)은 Higgsfield 호스티드 MCP를 사용합니다. 최초 1회 OAuth 인증이 필요합니다.

## 1. MCP 서버 연결

moai-story 플러그인의 `.mcp.json`이 Higgsfield 공식 호스티드 엔드포인트(`https://mcp.higgsfield.ai/mcp`)를 가리킵니다. Claude Code가 플러그인을 로드할 때 자동으로 등록합니다.
