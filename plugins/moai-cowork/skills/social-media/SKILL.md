...
name: social-media
description: |
  [DEPRECATED v2.3.0] 본 스킬은 moai-cowork:sns-content로 흡수되었습니다. 신규 호출은 /sns-content를 사용하세요.
...
본 스킬은 **v2.3.0부터 `moai-cowork:sns-content`로 흡수**되었습니다.
...
`moai-cowork:social-media`와 `moai-cowork:sns-content`가 SNS 콘텐츠 영역에서 책임 경계가 모호하여 셀러·마케터가 어디로 호출할지 혼동되는 문제를 해결하기 위해 단일 스킬로 통합했습니다 (SPEC-CATALOG-CLEANUP-007 REQ-CLEANUP-003).
...
Version: 2.3.0
Classification: DEPRECATED → moai-cowork:sns-content
