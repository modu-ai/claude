...
![Claude Design 기본 레이아웃 — 왼쪽 대화(chat), 오른쪽 캔버스(canvas)](/screenshots/claude-design/cd-access-layout.png)
...
![Claude Desktop 사이드바에서 Claude Design 진입](/screenshots/claude-design/cd-access-desktop.png)
...
![텍스트 프롬프트 한 줄로 생성된 첫 인터랙티브 시안](/screenshots/claude-design/cd-first-prompt.png)
...
**Q. 일반 채팅 한도를 먹나요?**
A. 예, 먹습니다. Claude Design은 일반 채팅·Claude Code와 동일한 **공유 풀**에서 사용량을 차감합니다 (별도 할당량 없음). 따라서 Claude Design을 많이 쓰면 채팅 한도가 줄어집니다. 한도를 초과하려면 Extra usage를 활성화해야 합니다.
