...
│ ├─ moai-coworker: ✓ (project, general-ai-slop-reviewer, general-feedback)
...
FOR each chain in CLAUDE.md "프로젝트 워크플로우":
  ...
  check_aislop_tail()         # 텍스트 산출물 체인 말미에 general-ai-slop-reviewer 포함
```
...
설치된 플러그인 (27개 중):
  ✓ moai-core (project, general-ai-slop-reviewer, general-feedback ...)
  ✓ moai-coworker (content-copywriting, marketing-landing-page ...)
  ✓ moai-coworker (office-docx-generator, office-pptx-designer ...)
  ... (총 27 플러그인 / 173 스킬)
