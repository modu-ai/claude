...
| 작업 | 스킬 | 데이터 소스 |
| --- | --- | --- |
| 실거래가·전월세 시세 | `moai-officer:office-public-data-real-estate-search` | 국토교통부 실거래가 신고 |
| **건축물 실체(용도·구조·규모·규제·인허가·노후·철거)** | **`moai-officer:office-building-ledger-search` (본 스킬)** | 국토교통부 건축HUB |
| 인구·가구 통계 | `moai-officer:office-public-data-public-data` | KOSIS |
| 법원 경매 매각공고 | `moai-officer:office-public-data-court-auction-search` | 대법원 경매정보 |

## 이 스킬을 사용하지 말아야 할 때

- **실거래가·전월세 시세** → `moai-officer:office-public-data-real-estate-search`
- **인구·고용·물가 등 통계** → `moai-officer:office-public-data-public-data` (KOSIS 자연어 우선)
- **법원 경매 매각공고·감정평가액·최저매각가** → `moai-officer:office-public-data-court-auction-search`
